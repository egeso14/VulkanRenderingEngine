...
namespace VTA {
    ...
    std::shared_ptr<VTADescriptorSetLayout> VTADescriptorSetLayout::Builder::build() const {
        return std::make_shared<VTADescriptorSetLayout>(device, bindings);
    }
    ...
    void VTADescriptorWriter::clear()
    {
        writes.clear();
    }
